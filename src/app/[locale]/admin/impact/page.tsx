      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-l from-primary-900 via-primary-700 to-secondary-700 p-6 md:p-8 text-white shadow-2xl">
        ...
        <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          <div>
            ...
            <p className="text-sm text-white/75 mt-3 max-w-2xl leading-7">أنشئ تقريرًا تقليديًا مباشرًا، أو ولّد تحليلًا ذكيًا محفوظًا في الأرشيف مع صفحة مستقلة للطباعة والتصدير.</p>
          </div>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-primary-100/60 bg-gradient-to-br from-primary-50/40 to-white p-5 md:p-6 mb-5 shadow-md">
          ...
          <div className="relative">
            <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
              <div>
                <h3 className="font-bold text-neutral-900 flex items-center gap-2 text-base"><FileText size={18} className="text-primary-600" /> التقارير الذكية المحفوظة</h3>
